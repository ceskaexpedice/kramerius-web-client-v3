/** Maps ISO 639-2/B (3-letter) codes to ISO 639-1 (2-letter) codes. */
export const languageMap: Record<string, string> = {
  ...
  cze: 'cs', dan: 'da', div: 'dv', dut: 'nl', dzo: 'dz', ell: 'el',
  eng: 'en', epo: 'eo', est: 'et', ewe: 'ee', fao: 'fo', fas: 'fa',
  fij: 'fj', fin: 'fi', fre: 'fr', fry: 'fy', ful: 'ff', geo: 'ka',
  ger: 'de', gla: 'gd', gle: 'ga', glg: 'gl', glv: 'gv', grn: 'gn',
  guj: 'gu', hat: 'ht', hau: 'ha', heb: 'he', her: 'hz', hin: 'hi',
  hmo: 'ho', hrv: 'hr', hun: 'hu', ibo: 'ig', ice: 'is', ido: 'io',
  ...
  kur: 'ku', lao: 'lo', lat: 'lat', lav: 'lv', lim: 'li', lin: 'ln',
  lit: 'lt', ltz: 'lb', lub: 'lu', lug: 'lg', mac: 'mk', mah: 'mh',
  mal: 'ml', mao: 'mi', mar: 'mr', may: 'ms', mkd: 'mk', mlg: 'mg',
  mlt: 'mt', mon: 'mn', mri: 'mi', msa: 'ms', nau: 'na', nav: 'nv',
  ...
  run: 'rn', rus: 'ru', sag: 'sg', san: 'sa', sin: 'si', slo: 'sk',
